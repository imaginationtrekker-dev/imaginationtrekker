  ...
  return (
    ...
    >
      ...
      <div className='sidebar_menu'>
        ...
        {/* Recognitions */}
        <Link href='/dashboard/recognitions' className={`sidebar_item ${pathname === '/dashboard/recognitions' ? 'active' : ''}`}>
          <div className='sidebar_item_content'>
            <svg xmlns='http://www.w3.org/2000/svg' width='20' height='20' viewBox='0 0 24 24' fill='none' stroke='currentColor' strokeWidth='2' strokeLinecap='round' strokeLinejoin='round'>
        ...
        {/* PDF Enquiries */}
        <Link href='/dashboard/pdf-enquiries' className={`sidebar_item ${pathname === '/dashboard/pdf-enquiries' ? 'active' : ''}`}>
          <div className='sidebar_item_content'>
            <svg xmlns='http://www.w3.org/2000/svg' width='20' height='20' viewBox='0 0 24 24' fill='none' stroke='currentColor' strokeWidth='2' strokeLinecap='round' strokeLinejoin='round'>
