      ...
      <div className="packages-container">
        ...
        <div className="packages-header">
          <div className="packages-header-left">
            <span className="packages-tag">Packages</span>
            <h2 className="packages-title">
              TOURS FOR EVERY TYPE OF{" "}
              <span className="packages-title-highlight">TRAVELER</span>
            </h2>
          </div>
        </div>
        ...
        <div className="packages-slider-wrapper">
          <button
            className="testimonials-nav-btn testimonials-nav-prev packages-nav-btn"
            onClick={goToPrev}
              ...
              {packages.map((pkg, index) => (
                <div key={pkg.id} className="package-card">
                  <Link
                    ...
                    className="package-card-image-link"
                  >
          ...
          <button
            className="testimonials-nav-btn testimonials-nav-next packages-nav-btn"
            onClick={goToNext}
